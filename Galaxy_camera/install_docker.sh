...
then
    ...
    cp -r "$CURRENT_PATH"/bin/resource/settings/GalaxyView_cn.ini "$CURRENT_PATH"/bin/resource/settings/GalaxyView.ini
	cp -r "$CURRENT_PATH"/bin/GxGigeIPConfig_cn "$CURRENT_PATH"/bin/GxGigeIPConfig
else
