...
export LD_LIBRARY_PATH=./:/$START_DIR/lib/Libusb:/$START_DIR/lib/GenICam/bin/:/$START_DIR/lib/GenICam/bin/$GENICAM_LIB_SUBDIR/:/$START_DIR/lib/:/$START_DIR/lib/Qt/:$LD_LIBRARY_PATH
./ShowImage
